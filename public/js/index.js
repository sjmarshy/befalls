...
/***/ function(module, exports, __webpack_require__) {
	...
	var d = __webpack_require__(159)(React);
	var m = __webpack_require__(160);
	var store = __webpack_require__(161);
	var AddSymptomForm = __webpack_require__(177);
	var addSocket = __webpack_require__(178).addSocket;
	...
	socket.on(m.GET_ENTRIES, function (entries) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var redux = __webpack_require__(162);
	var thunkMiddleware = __webpack_require__(171);
	var createLogger = __webpack_require__(172);
	var rootReducer = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var combineReducers = __webpack_require__(162).combineReducers;
	var entry = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ADD_ENTRY = __webpack_require__(175).ADD_ENTRY;
	var fromJS = __webpack_require__(176).fromJS;
	...
	module.exports = function () {
	  ...
	  switch (action.type) {
	    ...
	    case ADD_ENTRY:
	      ...
	      return state.set("entries", state.get("entries").set(action.timeCreated, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function addSymptom(socket, name, severity, timeCreated) {
	  ...
	  return function (dispatch) {
	    ...
	    socket.on("ACK:" + messageNo, function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var d = __webpack_require__(159)(React);
	var store = __webpack_require__(161);
	var addSymptom = __webpack_require__(175).addSymptom;
	...
	module.exports = React.createClass({
	  ...
	  updateSymptomName: function updateSymptomName(e) {
	  ...
	  updateSymptomSeverity: function updateSymptomSeverity(e) {
	  ...
	  onSubmitAddSymptomForm: function onSubmitAddSymptomForm(e) {

	    e.preventDefault();

	    var socket = store.getState().util.get("socket");

	    store.dispatch(addSymptom(socket, this.state.symptomName, this.state.symptomSeverity, Date.now()));
	  },

	  render: function render() {

	    return d("div[data-component='add-symptom-form']", {}, d("form.addsymptomform", { onSubmit: this.onSubmitAddSymptomForm }, d("input.nameinput[type=text][name=name]", { value: this.state.symptomName, onChange: this.updateSymptomName }), d("input.severityinput[type=range][max=10][name=severity]", { value: this.state.symptomSeverity, onChange: this.updateSymptomSeverity }), d("input.submitbutton[type=submit]", {})));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ADD_SOCKET = __webpack_require__(178).ADD_SOCKET;
	var fromJS = __webpack_require__(176).fromJS;

	module.exports = function () {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? fromJS({}) : arguments[0];
	  var action = arguments[1];
